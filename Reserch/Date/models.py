...
class Date(models.Model):
    ...
    first_name = models.CharField(max_length=200, db_index=True, blank=True, verbose_name='фамилия')
    last_name = models.CharField(max_length=200, db_index=True, blank=True, verbose_name='имя и отчество')
    ...
    def __str__(self):
        return '%s %s %s %s %s' % (self.created, self.first_name, self.last_name, self.age, self.iq)
